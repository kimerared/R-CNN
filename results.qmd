...
{{< pagebreak >}} {{< pagebreak >}} The last test was a real-time capture using a webcam using the original YOLOv8 Nano. The pre-trained model was able to detect and label correctly all the class objects in the room.

![Real-Time Object Detection and Classification](images/results/webcam.png){style="text-align: center;" fig-alt="Real-Time Object Detection and Classification"}
